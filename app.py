...
# --- ALL CSS + Navbar + Hero as ONE single HTML block ---
st.markdown(f"""
<style>
...
<div class="metrics-row">
    ...
    <div class="m-card">
        ...
        <div class="m-badge">{((curr_p-max_p)/max_p)*100:.1f}% da Máxima</div>
    </div>
    <div class="m-card">
...
with ch1:
    st.markdown("""
        ...
        <p style="margin:0; color:#64748b; font-size:0.85rem;">Fechamento Semanal (USD)</p>
    """, unsafe_allow_html=True)
with ch2:
    scale = st.radio("Escala", ["Logarítmica", "Linear"], horizontal=True, label_visibility="collapsed")
...
fig.update_layout(
    ...
    paper_bgcolor='white',
    plot_bgcolor='white',
    xaxis={"showgrid": False, "color": "#64748b", "zeroline": False},
    yaxis={"gridcolor": "#f1f5f9", "color": "#64748b", "tickformat": "$,", "zeroline": False},
...
# --- Bottom Info Section (pure HTML) ---
st.markdown(f"""
<div class="info-grid">
    <div class="info-card">
        <h4 style="font-weight:800; color:#0f172a; margin:0 0 1rem 0; font-size:1.25rem;">Retornos Decrescentes</h4>
        <p style="color:#64748b; font-size:0.85rem; line-height:1.7; margin-bottom:1.5rem;">
            À medida que o Bitcoin amadurece, os ganhos percentuais explosivos diminuem. Saímos de ciclos de 7000% para ciclos mais maduros.
        </p>

        <div style="display:flex; justify-content:space-between; font-size:0.7rem; font-weight:700; color:#64748b; margin-bottom:0.5rem;">
            <span>CICLO 2012</span><span>+7,371%</span>
        </div>
        <div class="bar-track"><div class="bar-fill" style="width:100%; background:#cbd5e1;"></div></div>

        <div style="display:flex; justify-content:space-between; font-size:0.7rem; font-weight:700; color:#64748b; margin-bottom:0.5rem;">
            <span>CICLO 2016</span><span>+2,785%</span>
        </div>
        <div class="bar-track"><div class="bar-fill" style="width:40%; background:#cbd5e1;"></div></div>

        <div style="display:flex; justify-content:space-between; font-size:0.7rem; font-weight:700; color:#64748b; margin-bottom:0.5rem;">
            <span>CICLO 2020</span><span>+734%</span>
        </div>
        <div class="bar-track"><div class="bar-fill" style="width:15%; background:#cbd5e1;"></div></div>

        <div style="display:flex; justify-content:space-between; font-size:0.7rem; font-weight:700; color:#64748b; margin-bottom:0.5rem;">
            <span>CICLO 2024 (ATUAL)</span><span>EM PROGRESSO</span>
        </div>
        <div class="bar-track" style="margin-bottom:0;"><div class="bar-fill" style="width:8%; background:#f97316;"></div></div>
    </div>
    ...
    <div class="info-dark">
        ...
        <p style="color:#94a3b8; font-size:0.85rem; line-height:1.7; margin-bottom:2.5rem;">
        ...
        <div style="display:flex; align-items:baseline; gap:0.75rem; margin-bottom:2rem;">
            ...
            <span style="color:#64748b; font-size:0.65rem; font-weight:800; text-transform:uppercase; letter-spacing:0.05em;">Alvo Conservador</span>
        </div>
        ...
        <div style="display:flex; align-items:baseline; gap:0.75rem;">
            ...
            <span style="color:#64748b; font-size:0.65rem; font-weight:800; text-transform:uppercase; letter-spacing:0.05em;">Alvo Otimista</span>
        </div>
    </div>
</div>

<div style="text-align:center; color:#cbd5e1; font-size:0.75rem; font-weight:500; padding-bottom:2rem;">
    BTC Intelligence Dashboard © 2026 • Dados via API Pública
</div>
""", unsafe_allow_html=True)
